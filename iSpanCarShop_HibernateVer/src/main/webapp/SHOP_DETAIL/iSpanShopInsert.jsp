<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<head>
			...
			<link href="http://localhost:8080/iSpanCarShop_HibernateVer/SHOP_DETAIL/vendor/fontawesome-free/css/all.min.css"
			...
			<link href="http://localhost:8080/iSpanCarShop_HibernateVer/SHOP_DETAIL/css/sb-admin-2.min.css" rel="stylesheet">
...
opacity:0.6;
		...
		<body id="page-top">
			...
			<script src="http://localhost:8080/iSpanCarShop_HibernateVer/SHOP_DETAIL/vendor/jquery/jquery.min.js"></script>
			<script
			...
			<script src="http://localhost:8080/iSpanCarShop_HibernateVer/SHOP_DETAIL/js/sb-admin-2.min.js"></script>
