				...
				<div class="container">
					...
					<div>
						...
						<form name="updateProductForm"
							action="iSpancarShop.UpdateShopDetail.controller"
							method="POST" enctype="multipart/form-data"
							>
							<table border="1">
								<thead>
									<tr bgcolor='transparent'>
										<th height="60" colspan="2" align="center"><h2
												style="margin: 0 auto;">
												<b>修改產品資料</b>
											</h2></th>
									</tr>
								...
								<tbody>
									<c:forEach var='sentno' items='${sentno}' varStatus="vs">
										...
										<tr bgcolor='transparent'>
											<td width="130" height="40" style="text-align: center"><font
												size="4">產品編號</font></td>
											<td width="600" height="40" align="left"><input required
												readonly id='productno'
												style="text-align: left; background-color: LightGray;"
												name="productno" value="${sentno.productno}" type="text"
												size="14"></td>
										</tr>
										<tr bgcolor='transparent'>
											<td width="120" height="40" style="text-align: center"><font
												size="4">產品名稱</font></td>
											<td width="600" height="40" align="left"><input required
												id='productname' style="text-align: left;"
										...
										<tr bgcolor='transparent'>
											...
											<td width="120" height="400" align="left"><textarea
													required rows="30" cols="90" name="productinfo">${sentno.productinfo}</textarea>
										</tr>
										<tr>
										<tr bgcolor='transparent'>
											<td width="120" height="40" style="text-align: center"><font
