...
<head>
    ...
    <link href="http://localhost:8080/Hibernate_web/src/main/webapp/script/css/styles.css" rel="stylesheet" />
...
<body id="page-top">
    ...
    <!-- Core theme JS-->
    <script src="http://localhost:8080/Hibernate_web/src/main/webapp/script/js/scripts.js"></script>
    <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
    <!-- * *                               SB Forms JS                               * *-->
