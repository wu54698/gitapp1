<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<head>
			...
			<link href="http://localhost:8080/iSpanCarShop/SHOP_DETAIL/vendor/fontawesome-free/css/all.min.css"
			...
			<link href="http://localhost:8080/iSpanCarShop/SHOP_DETAIL/css/sb-admin-2.min.css" rel="stylesheet">
		...
		<body id="page-top">
							...
							<form name="insertProductFormA" action="<c:url value='/InsertShopDetailServlet.do'  />"
								...
								<table border="1" id="insertP">
									...
									<tbody>
										...
										<tr bgcolor='transparent'>
											<td width="120" height="40"style="text-align: center"><font size="4">發售日期</font></td>
											<td width="600" height="40" align="left"><input class="tbodyset"
													name="uptime" value="${param.uptime}" type="text" size="14"
													id="datepicker">
										...
										<tr bgcolor='transparent'>
											...
											<td width="120" height="400" align="left">
												<textarea rows="30" cols="90" name="productinfo">${param.productinfo}</textarea>
												<!-- 									<input -->
										...
										<tr bgcolor='transparent'>
											...
											<td width="600" height="40" align="left"><input name="productimage"
			...
			<script src="http://localhost:8080/iSpanCarShop/SHOP_DETAIL/vendor/jquery/jquery.min.js"></script>
			<script
			...
			<script src="http://localhost:8080/iSpanCarShop/SHOP_DETAIL/js/sb-admin-2.min.js"></script>
