...
<body>
	<form name="insertProductFormA"
		action="<c:url value='/InsertShopDetailServlet.do'  />" method="POST" enctype="multipart/form-data">
		<table border="1">
			<thead>
				<tr bgcolor='tan'>
			...
			<tbody>
				...
				<td width="120" height="40">產品圖片:</td>
					<td width="600" height="40" align="left"><input  name="productimage" value="${param.productimage}" type="file">
				</tr>
				<tr bgcolor='tan'>
