									...
									<div class="form-row align-items-center">
										<div class="form-group col-xl-4 col-lg-3 col-md-6">
											<input type="text" class="form-control my-2 my-lg-0" id="inputtext4"
												placeholder="What are you looking for" name="productname">
										</div>
										...
										<div class="form-group col-xl-2 col-lg-3 col-md-6">
											...
											<button type="submit" class="btn btn-primary active w-100"
												formaction="iSpancarShop.SearchResultShopPage">Search Now</button>
										</div>
									</div>
								</form>
							</div>
							...
							<div class="category-sidebar">
								<div class="widget category-list">
									...
									<ul class="category-list">
										<li><a href="#" onclick="goToTypePage()" class="takename">輪胎</a></li>
										<li><a href="#" onclick="goToTypePage()" class="takename">外飾</a></li>
										<li><a href="#" onclick="goToTypePage()" class="takename">內飾</a></li>
										<li><a href="#" onclick="goToTypePage()" class="takename">機油</a></li>
										<li><a href="#" onclick="goToTypePage()" class="takename">配件</a></li>
									</ul>
								</div>
								...
								<div class="widget price-range w-100">
									...
									<div class="block">
										<input class="range-track w-100" type="text" data-slider-min="0"
											data-slider-max="5000" data-slider-step="5" data-slider-value="[0,5000]">
											...
											<div class="product-item bg-light">
												<div class="card">
													...
													<div class="thumb-content">
														<a href="#" onclick="goToDetailPage2()" class="loadingName">
															<img style="border-radius:10%;display: block; margin: 0 auto;" 
																src="http://localhost:8080/iSpanCar/script/img/shoppage/tire.jpg"
													...
													<div class="card-body">
														...
														<ul class="list-inline product-meta">
															<li class="priceMark" style="text-align: center;">輪胎</li>
														</ul>
													</div>
												</div>
											</div>
