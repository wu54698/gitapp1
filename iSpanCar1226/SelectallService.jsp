...
<body id="page-top">
	...
	<table border="1">
		...
		<c:forEach var="Service" items="${serviceSelectall}" varStatus="vs">
	...
	<input type ="button" onclick="location.href='/iSpanCar/Service/SelectService3.jsp'" value="查詢保養廠"></input>
				</div>
				<!-- /.container-fluid -->
