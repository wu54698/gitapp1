...
<label>保養廠名稱：</label><input type="text" name="servicename" required /><br>
						...
						<textarea name="Servicedescription" rows="6" cols="40" >
          </textarea><br>
...
<!--                 </div> -->
	...
	<script src="http://localhost:8080/jspExercise/script/vendor/jquery/jquery.min.js"></script>
	<script src="http://localhost:8080/jspExercise/script/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

	<!-- Core plugin JavaScript-->
	<script src="http://localhost:8080/jspExercise/script/vendor/jquery-easing/jquery.easing.min.js"></script>
