...
<body id="page-top">
			...
			<div id="content">
				...
				<div class="container-fluid"
					...
					<form id="signin" action="" method="POST"
						...
						<label>保養廠名稱：</label><input type="text" id="servicename" name="servicename"required /><br>
						<label>保養廠描述：</label><br>
						<textarea name="Servicedescription" id="Servicedescription" rows="6" cols="40" required></textarea>
						<br> <label>保養廠資訊：</label><input type="text"
							name="Serviceinfomation" id="Serviceinfomation"><br> <label>保養廠聯繫：</label><input
							type="text" name="Contactperson" id="Contactperson"><br> <label>原場副廠：</label><select
							name="Resellernonreseller" id="Resellernonreseller">
							<option value="原廠">原廠</option>
							<option value="副廠">副廠</option>
						</select><br> <label>保養廠圖片</label><input type="file" name="Carimage"><br>

						<input type="submit" value="新增"
							formaction="backstage/serviceInsert.controller">
						<input
	...
	$('#inputForm').on('click', function(){
		...
		$('#Servicedescription').val('提供完善的汽車保養、汽車檢修、汽車改裝、汽車烤漆、您要的服務我們都有！')
		$('#Serviceinfomation').val('台北市大安區復興南路一段390號、全年無休、早上9:00~晚上9:45')
		$('#Contactperson').val('電話:02-66316588')
		$('#Resellernonreseller').val('原廠')
	})
	</script>
