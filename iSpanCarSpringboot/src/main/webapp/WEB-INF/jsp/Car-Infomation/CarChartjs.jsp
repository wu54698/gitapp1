		...
		<body id="page-top">
			...
			<div id="wrapper">
				...
				<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion bg-gradient-info"
					...
					<li class="nav-item"><a class="nav-link" href="findAllDealer.controller"> <i
								class="fa-solid fa-car"></i>
							<span>車廠</span>
						</a></li>
					<li class="nav-item"><a class="nav-link" href="SelectAllCar.controller"> <i
								class="fa-solid fa-car"></i>
							<span>車輛</span>
						</a></li>
					...
					<li class="nav-item"><a class="nav-link" href="serviceAllController"> <i
								class="fa-solid fa-screwdriver-wrench"></i> <span>保養廠</span></a></li>
					...
					<!-- Nav Item - Tables -->
					<li class="nav-item"><a class="nav-link" href="iSpancarShop.ProductListAll"> <i
								class="fa-sharp fa-solid fa-cart-shopping"></i> <span>商城</span></a></li>

					<li class="nav-item"><a class="nav-link" href="orderQueryAll.controller"> <i
				...
				<div id="content-wrapper" class="d-flex flex-column">
					...
					<div id="content">
							...
							<ul class="navbar-nav ml-auto">
								...
								<li class="nav-item dropdown no-arrow"><a class="nav-link dropdown-toggle" href="#"
										...
										<!-- 職位 --> <input type="hidden" value="${login.accountnumber}"
											...
											value="${memberPosition.positionPk}" id="myPosition"> <input type="hidden"
											value="${memberPosition.permissionsInsert}" id="myPositionInsert"> <input
											type="hidden" value="${memberPosition.permissionsUpdate}"
											id="myPositionUpdate"> <input type="hidden"
											value="${memberPosition.permissionsDelete}" id="myPositionDelete"> <input
											type="hidden" value="${memberPosition.permissionsSelect}"
											id="myPositionSelect"> <img class="img-profile rounded-circle" id="myImage"
						...
						<div class="container-fluid">
							...
							<div class="row">
								<div class="col-sm-2 ">
									<h1 class="h3 mb-4 text-gray-800 d-inline-flex">統計圖表</h1>
								</div>
								<div class="col-sm-10 ">
							...
							<h3>總車輛數: <span id="total-amount" class=""></span></h3>
							<div class="row">
								<div class="col-sm-6 ">
									<canvas width="1000" height="700" id="announceDateChart"
			...
			<script>
				fetch('/backstage/announceDateChart.controller')
					...
					.then(data => {
						...
						data.forEach(function (element) {
							labels.push(Object.keys(element))			//月份的key
							values.push(Object.values(element)[0])		//每一筆都是陣列，所以取第一個
							totalAmount += Object.values(element)[0];	//取總數
						})
						...
						//在圖表做設定
						const ctx = document.getElementById('announceDateChart').getContext('2d');
						const announceDateChart = new Chart(ctx, {
							type: 'line',
							data: {
								labels: labels,
								datasets: [{
