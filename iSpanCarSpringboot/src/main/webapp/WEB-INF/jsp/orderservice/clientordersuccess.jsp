...
<!--                                 style="color:white;font-size:6em;font-family: 'Noto Sans TC', sans-serif;">預約成功</h2> -->
    ...
    <div class="col-10 bg-white text-center rounded">
      ...
      <div class="container">
        <br><div class="row justify-content-center">
         		<h1 class="h3 mb-4 text-gray-800">預約成功</h1>
					<form id="signin" action="" enctype="multipart/form-data">
						
						<br> <br> 
						</form>
						<a class="btn btn-primary"
							href="clientserviceAllController">回到保養廠頁面</a><br>
