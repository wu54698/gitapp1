...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link"
				href="findAllDealer.controller"> <i class="fa-solid fa-car"></i>
					<span>車廠</span>
			</a></li>
			<li class="nav-item"><a class="nav-link"
			...
			<li class="nav-item"><a class="nav-link"
				href="orderQueryAll.controller"> <i class="fa-solid fa-coins"></i>
					<span>訂單</span>
			</a></li>
			<!-- Divider -->
						...
						<div class="container-fluid">
							...
							<form name="selectToUpdate" action="" method="POST"
								...
								<table border="1" id="insertP">
									...
									<tbody>
										...
										<tr bgcolor='transparent'>
											...
											<tr bgcolor='transparent'>
												<td width="120" height="40">預約姓名：</td>
												<td width="600" height="40" align="left"><input
													id="ordername" name="ordername" class="checkNotNull"
													value="${toUpdate.ordername}" type="text" size="14"
													style="text-align: left; background-color: transparent; border-style: 1;"readonly></td>
											</tr>

											<tr bgcolor='transparent'>
												<td width="120" height="40">預約電子郵件：</td>
												<td width="600" height="40" align="left"><input
													id="orderemail" name="orderemail" class="checkNotNull"
													value="${toUpdate.orderemail}" type="text" size="60"
													style="text-align: left"></td>
											</tr>
											<tr bgcolor='transparent'>
												<td width="120" height="40">預約電話：</td>
												<td width="600" height="40" align="left"><input
													id="orderphonenumber" name="orderphonenumber"
													class="checkNotNull" value="${toUpdate.orderphonenumber}"
													type="text" size="60" style="text-align: left"></td>
											</tr>
											<tr bgcolor='transparent'>
												<td width="120" height="40">預約日期：</td>
												<td width="600" height="40" align="left"><input
													id="orderdate" name="orderdate" class="checkNotNull"
													type="date" value="${toUpdate.orderdate}" size="60"
													style="text-align: left"></td>
											</tr>
											<tr bgcolor='transparent'>
												<td width="120" height="40">預約時間：</td>
												<td width="600" height="40" align="left"><input
													id="ordertime" name="ordertime" class="checkNotNull"
													type="time" value="${toUpdate.ordertime}" size="60"
													style="text-align: left"></td>
											</tr>
											<tr bgcolor='transparent'>
												<td width="120" height="40">預約項目：</td>
												<td width="600" height="40" align="left"><select
													id="orderproduct" name="orderproduct"
													class="checkNotNull" style="text-align: left">
														<option value="保養相關"
															${toUpdate.orderproduct == '保養相關' ? 'selected' : ''}>保養相關</option>
														<option value="維修相關"
															${toUpdate.orderproduct == '維修相關' ? 'selected' : ''}>維修相關</option>
														<option value="改裝相關"
															${toUpdate.orderproduct == '改裝相關' ? 'selected' : ''}>改裝相關</option>
														<option value="輪胎相關"
															${toUpdate.orderproduct == '輪胎相關' ? 'selected' : ''}>輪胎相關</option>
														<option value="鈑漆相關"
															${toUpdate.orderproduct == '鈑漆相關' ? 'selected' : ''}>鈑漆相關</option>
														<option value="車輛檢查"
															${toUpdate.orderproduct == '車輛檢查' ? 'selected' : ''}>車輛檢查</option>
														<option value="其他"
															${toUpdate.orderproduct == '其他' ? 'selected' : ''}>其他</option>					
												</select></td>
											</tr>											
											<tr bgcolor='transparent'>
												<td width="120" height="40">備註：</td>
												<td width="600" height="40" align="left"><textarea
														id="orderremarks" name="orderremarks" class="checkNotNull"
														rows="6" cols="60" style="text-align: left">${toUpdate.orderremarks}</textarea></td>
											</tr>
								...
								<input type="submit" value="更改"
									formaction="<c:url value='serviceorderUpdateController'/>">
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<a class="btn btn-primary" href="/logout.controller">登出</a>
						</div>
