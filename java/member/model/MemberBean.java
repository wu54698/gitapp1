...
//	private java.sql.Timestamp registerDate; // 會員登錄日期
	...
	public MemberBean(String accountnumber, String memberpassword, String memberName, String phonenumber, String email,
			String memberaddress, String platenumber, String birthday, String idnumber, Blob file, String filename) {
		super();
		this.accountnumber = accountnumber;
	...
	//無圖
	public MemberBean(String accountnumber, String memberpassword, String memberName, String phonenumber, String email,
			String memberaddress, String platenumber, String birthday, String idnumber) {
		super();
		this.accountnumber = accountnumber;
		this.memberpassword = memberpassword;
		this.memberName = memberName;
