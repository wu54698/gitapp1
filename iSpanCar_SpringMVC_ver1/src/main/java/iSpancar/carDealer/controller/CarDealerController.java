...
public class CarDealerController {
	...
	public String addDealerAction(@RequestParam("carDealName") String carDealName, @RequestParam("carDealPhone") String carDealPhone,
							@RequestParam("carDealAddress") String carDealAddress, @RequestParam("openTime") String openTime,
							@RequestParam("contactPerson") String contactPerson, @RequestParam("carDealVATNumber") int carDealVATNumber, Model m) {
	...
	public String updateDealerAction(@RequestParam("carDealName") String carDealName, @RequestParam("carDealPhone") String carDealPhone,
			@RequestParam("carDealAddress") String carDealAddress, @RequestParam("openTime") String openTime,
			@RequestParam("contactPerson") String contactPerson, @RequestParam("carDealVATNumber") String carDealVATNumber, Model m) {
