<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<head>
			...
			<link href="http://localhost:8080/iSpan_Car/CSSFrame/vendor/fontawesome-free/css/all.min.css"
		...
		<body id="page-top">
							...
							<div class="container1">
								...
								<table id="selectAllDealer">
									...
									<c:forEach var="dealer" items="${SelectAllDealer}" varStatus="vs">
										<tbody>
											<tr>
												<td id="carDealerName">${dealer.carDealName}</td>
			...
			<script>
				$('.container1').on('click', '#btn1', function () {
					$.ajax({
						type: "POST",
						url: "<c:url value='/DeleteCarDealerServlet.do'/>",
						//contentType text
						context: this,
						dataType: "text",
						data: {
