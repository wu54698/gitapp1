...
<link
	href="http://localhost:8080/iSpan_Car/CSSFrame/vendor/fontawesome-free/css/all.min.css"
...
<link
	href="http://localhost:8080/iSpan_Car/CSSFrame/css/sb-admin-2.min.css"
	rel="stylesheet">
...
<body id="page-top">
	...
	<script
		src="http://localhost:8080/iSpan_Car/CSSFrame/vendor/jquery/jquery.min.js"></script>
	<script
		src="http://localhost:8080/iSpan_Car/CSSFrame/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

	<!-- Core plugin JavaScript-->
	<script
		src="http://localhost:8080/iSpan_Car/CSSFrame/vendor/jquery-easing/jquery.easing.min.js"></script>

	<!-- Custom scripts for all pages-->
	<script
		src="http://localhost:8080/iSpan_Car/CSSFrame/js/sb-admin-2.min.js"></script>
