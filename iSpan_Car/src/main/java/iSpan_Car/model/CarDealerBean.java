...
public class CarDealerBean {
	...
	public CarDealerBean(String carDealName, int carDealPhone, String carDealAddress, String openTime,
	...
	public int getCarDealPhone() {
		return carDealPhone;
	}


	public void setCarDealPhone(int carDealPhone) {
		this.carDealPhone = carDealPhone;
	}
