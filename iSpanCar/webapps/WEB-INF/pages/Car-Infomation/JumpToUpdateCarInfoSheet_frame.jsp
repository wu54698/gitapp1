	...
	<div id="wrapper">
        ...
        <tbody>
            ...
            <tr bgcolor='transparent'>
                ...
                <td width="600" height="40" align="left"><input id="carNo" name="carNo" class="checkNotNull" value="${toUpdate.carNo}"
                        type="text" size="14" style="text-align: left; background-color: transparent; border-style:none;" readonly></td>
            </tr>
            <tr bgcolor='transparent'>
                <td width="120" height="40">車商名稱</td>
                <td width="600" height="40" align="left"><input id="carDealName" name="carDealName" class="checkNotNull"
                        value="${toUpdate.carDealerBean.carDealName}" type="text" size="14" style="text-align: left; background-color: transparent; border-style:none;" readonly></td>
            </tr>
            <tr bgcolor='transparent'>
                ...
                <td width="600" height="40" align="left"><input id="accountNumber" name="accountNumber" class="checkNotNull"
                        value="${toUpdate.accountNumber}" type="text" size="14" style="text-align: left">
                </td>
            </tr>
            <tr bgcolor='transparent'>
                <td width="120" height="40">車輛品牌</td>
                <td width="600" height="40" align="left"><input id="carBrand" name="carBrand" class="checkNotNull" value="${toUpdate.carBrand}"
                        type="text" size="14" style="text-align: left"></td>
            </tr>
            <tr bgcolor='transparent'>
                <td width="120" height="40">車輛名稱</td>
                <td width="600" height="40" align="left"><input id="carName" name="carName" class="checkNotNull" value="${toUpdate.carName}"
                        type="text" size="14" style="text-align: left"></td>
            </tr>
            <tr bgcolor='transparent'>
                <td width="120" height="40">庫存</td>
                <td width="600" height="40" align="left"><input id="stock" name="stock" class="checkNotNull" value="${toUpdate.stock}"
            ...
            <tr bgcolor='transparent'>
                ...
                <td width="600" height="40" align="left">
                    <textarea id="carDescription" name="carDescription" class="checkNotNull" cols="30"
                        rows="10" style="text-align: left">${toUpdate.carDescription}</textarea>
                </td>
            </tr>
            <tr bgcolor='transparent'>
            ...
            <tr>
                ...
                <td width="600" height="40" align="left"><input id="announceDate" name="announceDate" class="checkNotNull"
                        value="${toUpdate.announceDate}" type="text" size="14" style="text-align: left">
