<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<head>
			...
			<link href="http://localhost:8080/jspExercise/script/vendor/fontawesome-free/css/all.min.css"
			...
			<link href="http://localhost:8080/jspExercise/script/css/sb-admin-2.min.css" rel="stylesheet">
