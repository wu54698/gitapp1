...
public class MemberDao {
	...
	public List<MemberBean> findbyaccountnumber(String accountnumber) throws SQLException{
		...
		while(rs.next()) {
			...
			mb.setCardnumber(rs.getString("cardnumber"));
	...
	public void insertMemberBean(MemberBean bean) throws SQLException, ParseException {
		...
		preparedStatement.setString(4,bean.getPhonenumber());
		...
		preparedStatement.setString(10, bean.getCardnumber());
		preparedStatement.setBlob(11, bean.getFile());
		preparedStatement.setString(12, bean.getFilename());
	...
	public void updateByAccountnumber(MemberBean mb) throws SQLException, ParseException {
		...
		preState.setString(9,mb.getCardnumber());
		preState.setString(10, mb.getAccountnumber());
	...
	public void updateImgByAccount(String accountnumber,Blob personalimg) throws SQLException {
		String sql ="Update member set personalimg = ? where accountnumber = ?";
		Connection conn= ds.getConnection();
		PreparedStatement preparedStatement = conn.prepareStatement(sql);
		preparedStatement.setBlob(1, personalimg);
