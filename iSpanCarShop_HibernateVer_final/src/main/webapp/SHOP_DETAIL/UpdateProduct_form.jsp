...
<link
	href="http://localhost:8080/iSpanCarShop_HibernateVer/SHOP_DETAIL/vendor/fontawesome-free/css/all.min.css"
...
<link
	href="http://localhost:8080/iSpanCarShop_HibernateVer/SHOP_DETAIL/css/sb-admin-2.min.css"
	rel="stylesheet">
<link
...
<body id="page-top">
	...
	<div id="wrapper">
								...
								varStatus="vs">
									<tr bgcolor='transparent'>
										...
										<td width="600" height="40" align="left"><input required readonly
											...
											value="${sentno.productno}" type="number" size="14"></td>
									</tr>
									<tr bgcolor='transparent'>
									...
									<tr bgcolor='transparent'>
										...
										<td width="600" height="40" align="left"><input required
											name="price" value="${sentno.price}" type="number" size="14"></td>
									</tr>
									<tr bgcolor='transparent'>
										<td width="120" height="40" style="text-align: center"><font size="4">庫存數量</font></td>
										<td width="600" height="40" align="left"><input required
											name="stock" value="${sentno.stock}" type="number" size="14"></td>
									</tr>
									<!-- 				<tr bgcolor='tan'> -->
		...
		<script
			src="http://localhost:8080/iSpanCarShop_HibernateVer/SHOP_DETAIL/vendor/jquery/jquery.min.js"></script>
		<script
			src="http://localhost:8080/iSpanCarShop_HibernateVer/SHOP_DETAIL/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

		<!-- Core plugin JavaScript-->
		<script
			src="http://localhost:8080/iSpanCarShop_HibernateVer/SHOP_DETAIL/vendor/jquery-easing/jquery.easing.min.js"></script>

		<!-- Custom scripts for all pages-->
		<script
			src="http://localhost:8080/iSpanCarShop_HibernateVer/SHOP_DETAIL/js/sb-admin-2.min.js"></script>
