...
import tw.hibernatedemo.model.Category;
import tw.hibernatedemo.model.ForumMember;
import tw.hibernatedemo.model.Post;
import tw.hibernatedemo.model.Thread;
...
public class QueryHelper {
	...
	public Thread newThread(int categoryId) {
		...
		tw.hibernatedemo.model.Thread thread = new tw.hibernatedemo.model.Thread();
